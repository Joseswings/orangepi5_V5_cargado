...
class SDL_Pi_INA3221():
    ...
    # twi = numero de i2c de la nanopi
    ###########################
    # INA3221 Code
    ###########################
    def __init__(self, twi=3, addr=INA3221_ADDRESS, shunt_resistor=SHUNT_RESISTOR_VALUE):
...
class SDL_Pi_INA3221_2():

    # twi = numero de i2c de la nanopi
    ###########################
    # INA3221 Code
    ###########################
    def __init__(self, twi=3, addr=INA3221_ADDRESS2, shunt_resistor=SHUNT_RESISTOR_VALUE_2):
        self._bus = smbus.SMBus(twi)
        self._addr = addr
        config = INA3221_CONFIG_ENABLE_CHAN1 |		\
            INA3221_CONFIG_ENABLE_CHAN2 |	\
    ...
    def getCurrent_mA(self, channel):
        ...
        valueDec = self.getShuntVoltage_mV(channel) / SHUNT_RESISTOR_VALUE_2
        return valueDec
